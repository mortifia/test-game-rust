...
struct BirdResources {
    ...
    material_rng: rand::rngs::StdRng,
    velocity_rng: rand::rngs::StdRng,
    transform_rng: rand::rngs::StdRng,
}
...
fn setup(
    ...
    let mut bird_resources = BirdResources {
        ...
        color_rng: rand::rngs::StdRng::seed_from_u64(42),
        material_rng: rand::rngs::StdRng::seed_from_u64(42),
        velocity_rng: rand::rngs::StdRng::seed_from_u64(42),
        transform_rng: rand::rngs::StdRng::seed_from_u64(42),
    };
...
fn bird_velocity_transform(
    ...
    velocity_rng: &mut rand::rngs::StdRng,
    waves: Option<usize>,
    dt: f32,
) -> (Transform, Vec3) {
...
fn init_textures(textures: &mut Vec<Handle<Image>>, args: &Args, images: &mut Assets<Image>) {
    // We're seeding the PRNG here to make this example deterministic for testing purposes.
    // This isn't strictly required in practical use unless you need your app to be deterministic.
    let mut color_rng = rand::rngs::StdRng::seed_from_u64(42);
...
fn init_materials(
    ...
    // This isn't strictly required in practical use unless you need your app to be deterministic.
    let mut color_rng = rand::rngs::StdRng::seed_from_u64(42);
    let mut texture_rng = rand::rngs::StdRng::seed_from_u64(42);
    materials.extend(
